...
class Globals {
	...
	public static void setDownloadUrls() {
		String[] urlsFree = {
			"zip|res|wesnoth.zip.jet|18610",
		};
		String[] urlsUnlicensed = {
			"zip|res|wesnoth.zip.jet|18610",
			"tar|s3|battle-for-wesnoth-1866|wesnoth_unlicensed.tar",
		};
		String[] urlsFull = {
			"zip|res|wesnoth.zip.jet|18610",

			"tar|s3|battle-for-wesnoth-1866|data_core_music.tar",
			"tar|s3|battle-for-wesnoth-1866|data_core_images.tar",

			//"tar|s3|battle-for-wesnoth-1866|multiplayer.tar",

			// campaigns
			// TODO(cjhopman): convert these to s3 w/ gatekeeper authorization

			"tar|s3|battle-for-wesnoth-1866|an_orcish_incursion.tar",
			"tar|s3|battle-for-wesnoth-1866|delfadors_memoirs.tar",
			"tar|s3|battle-for-wesnoth-1866|descent_into_darkness.tar",
			"tar|s3|battle-for-wesnoth-1866|eastern_invasion.tar",
			"tar|s3|battle-for-wesnoth-1866|heir_to_the_throne.tar",
			"tar|s3|battle-for-wesnoth-1866|legend_of_wesmere.tar",
			"tar|s3|battle-for-wesnoth-1866|liberty.tar",
			"tar|s3|battle-for-wesnoth-1866|northern_rebirth.tar",
			"tar|s3|battle-for-wesnoth-1866|sceptre_of_fire.tar",
			"tar|s3|battle-for-wesnoth-1866|son_of_the_black_eye.tar",
			"tar|s3|battle-for-wesnoth-1866|the_hammer_of_thursagen.tar",
			"tar|s3|battle-for-wesnoth-1866|the_rise_of_wesnoth.tar",
			"tar|s3|battle-for-wesnoth-1866|the_south_guard.tar",
			"tar|s3|battle-for-wesnoth-1866|two_brothers.tar",
			"tar|s3|battle-for-wesnoth-1866|under_the_burning_suns.tar",
		};

		String packageName = "com.androthsoft.battle";
