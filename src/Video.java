...
class DemoRenderer extends GLSurfaceView_SDL.Renderer {
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        Log.v("SDL", "DemoRenderer.onSurfaceCreated(): paused " + mPaused + " mFirstTimeStart " + mFirstTimeStart );
    ...
    public void onSurfaceChanged(GL10 gl, int w, int h) {
        Log.v("SDL", "DemoRenderer.onSurfaceChanged(): paused " + mPaused + " mFirstTimeStart " + mFirstTimeStart );
        nativeResize(w, h, Globals.KeepAspectRatio ? 1 : 0);
    }

    public void onSurfaceDestroyed() {
        Log.v("SDL", "DemoRenderer.onSurfaceDestroyed(): paused " + mPaused + " mFirstTimeStart " + mFirstTimeStart );
	...
	public void onDrawFrame(GL10 gl) {
		...
		nativeInit( Globals.DataDir,
					Globals.CommandLine,
					( Globals.SwVideoMode && Globals.MultiThreadedVideo ) ? 1 : 0 ); // Calls main() and never returns, we'll call eglSwapBuffers() from native code
...
class DemoGLSurfaceView extends GLSurfaceView_SDL {
	...
	public void onResume() {
		...
		Log.v("SDL", "DemoGLSurfaceView.onResume(): mRenderer.mGlSurfaceCreated " + mRenderer.mGlSurfaceCreated + " mRenderer.mPaused " + mRenderer.mPaused);
